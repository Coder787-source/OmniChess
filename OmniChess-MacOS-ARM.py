...
class ChessTitan:
    def __init__(self):
        ...
        self.font_piece = pygame.font.SysFont("applesymbols,Arial Unicode MS", 72)
        self.font_captured = pygame.font.SysFont("applesymbols,Arial Unicode MS", 30)
        self.font_ui = pygame.font.SysFont("helveticaneue", 20, bold=True)
        self.font_tiny = pygame.font.SysFont("helveticaneue", 14, bold=True)
        self.font_credit = pygame.font.SysFont("helveticaneue", 12, bold=True)
        self.font_big = pygame.font.SysFont("helveticaneue", 45, bold=True)
    ...
    def draw_board(self):
        ...
        for sq in chess.SQUARES:
            ...
            if piece:
                ...
                piece_surf = self.font_piece.render(SYMBOLS[piece.symbol()], True, p_color)
                px = x + (SQUARE_SIZE - piece_surf.get_width()) // 2
                py = y + (SQUARE_SIZE - piece_surf.get_height()) // 2
