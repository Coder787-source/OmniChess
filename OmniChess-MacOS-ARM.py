...
class ChessTitan:
    def __init__(self):
        ...
        self.font_piece = pygame.font.SysFont("dejavusans", 72)
        self.font_captured = pygame.font.SysFont("dejavusans", 30)
        self.font_ui = pygame.font.SysFont("dejavusans", 20, bold=True)
        self.font_tiny = pygame.font.SysFont("dejavusans", 14, bold=True)
        self.font_credit = pygame.font.SysFont("dejavusans", 12, bold=True)
        self.font_big = pygame.font.SysFont("dejavusans", 45, bold=True)
